...
<section id="cart_items">
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<!-- loop_start -->
					<forEach var="p" items="${productList}"
						<tr>
							<td class="cart_product">
								<a href=""><img src="<%=basePath%>getImg?id=${productId}"
							...
							<%
								com.HuJiayi.model.Product p = (com.HuJiayi.model.Product)pageContext.findAttribute("p");
								int pid = p.getProductId();
								java.sql.Connection con = (java.sql.Connection)application.getAttribute("con");
								String catName = com.HuJiayi.model.Category.findByCategoryId(con,pid);
							%>
